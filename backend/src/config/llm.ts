...
> = {
  ...
  anthropic: {
    ...
    investigateSubagent: "claude-haiku-4-5",
  },
  google: {
  ...
  deepseek: {
    schemaInference: "deepseek-v4-pro",
    populateOrchestrator: "deepseek-v4-pro",
    investigateSubagent: "deepseek-v4-flash",
  },
  qwen: {
    schemaInference: "qwen3-max",
    populateOrchestrator: "qwen3-max",
  ...
  groq: {
    ...
    investigateSubagent: "openai/gpt-oss-20b",
  },
  togetherai: {
  ...
  deepinfra: {
    schemaInference: "deepseek-ai/DeepSeek-V4-Pro",
    populateOrchestrator: "deepseek-ai/DeepSeek-V4-Pro",
    investigateSubagent: "deepseek-ai/DeepSeek-V4-Flash",
  },
  fireworks: {
    schemaInference: "accounts/fireworks/models/glm-5p2",
    populateOrchestrator: "accounts/fireworks/models/glm-5p2",
    investigateSubagent: "accounts/fireworks/models/glm-5p2",
  },
  huggingface: {
    schemaInference: "zai-org/GLM-5.2",
    populateOrchestrator: "zai-org/GLM-5.2",
    investigateSubagent: "Qwen/Qwen3.5-9B",
  },
  ollama: {
    schemaInference: "",
    populateOrchestrator: "",
